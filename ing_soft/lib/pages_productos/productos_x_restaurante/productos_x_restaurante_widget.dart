...
import 'productos_x_restaurante_model.dart';
export 'productos_x_restaurante_model.dart';

class ProductosXRestauranteWidget extends StatefulWidget {
  const ProductosXRestauranteWidget({
    Key? key,
    required this.rest,
  }) : super(key: key);
  ...
  @override
  _ProductosXRestauranteWidgetState createState() =>
      _ProductosXRestauranteWidgetState();
}

class _ProductosXRestauranteWidgetState
    extends State<ProductosXRestauranteWidget> {
  late ProductosXRestauranteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosXRestauranteModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> productosXRestauranteCarritoRecordList =
            snapshot.data!;
        final productosXRestauranteCarritoRecord =
            productosXRestauranteCarritoRecordList.isNotEmpty
                ? productosXRestauranteCarritoRecordList.first
                : null;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                Visibility(
                  visible: productosXRestauranteCarritoRecord != null,
                  child: Padding(
                    padding:
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                if (productosXRestauranteCarritoRecord !=
                                                    null) {
                                                  ...
                                                  await productosXRestauranteCarritoRecord!
                                                      .reference
                                                      .update({
                                                    ...mapToFirestore(
                                                      {
