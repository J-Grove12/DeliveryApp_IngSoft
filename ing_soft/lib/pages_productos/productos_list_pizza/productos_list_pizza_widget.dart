...
import 'productos_list_pizza_model.dart';
export 'productos_list_pizza_model.dart';

class ProductosListPizzaWidget extends StatefulWidget {
  const ProductosListPizzaWidget({Key? key}) : super(key: key);

  @override
  _ProductosListPizzaWidgetState createState() =>
      _ProductosListPizzaWidgetState();
}

class _ProductosListPizzaWidgetState extends State<ProductosListPizzaWidget> {
  late ProductosListPizzaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosListPizzaModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> productosListPizzaCarritoRecordList =
            snapshot.data!;
        final productosListPizzaCarritoRecord =
            productosListPizzaCarritoRecordList.isNotEmpty
                ? productosListPizzaCarritoRecordList.first
                : null;
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                if (productosListPizzaCarritoRecord !=
                                                    null) {
                                                  ...
                                                  await productosListPizzaCarritoRecord!
                                                      .reference
                                                      .update({
                                                    ...mapToFirestore(
                                                      {
