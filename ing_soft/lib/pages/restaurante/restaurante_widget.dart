...
class RestauranteWidget extends StatefulWidget {
  const RestauranteWidget({Key? key}) : super(key: key);

  @override
  _RestauranteWidgetState createState() => _RestauranteWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RestauranteRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RestauranteRecord> restauranteRestauranteRecordList =
            snapshot.data!;
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                            ...
                            () async {
                              safeSetState(() {
                                _model.simpleSearchResults = TextSearch(
                                  restauranteRestauranteRecordList
                                      .map(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Busca tu restaurante',
                            labelStyle:
                      ...
                      child: Stack(
                        children: [
                          if (FFAppState().Buscando == false)
                            Builder(
                              builder: (context) {
                                final restaurantesTodos =
                                    restauranteRestauranteRecordList.toList();
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: restaurantesTodos.length,
                                  itemBuilder:
                                      (context, restaurantesTodosIndex) {
                                    final restaurantesTodosItem =
                                        restaurantesTodos[
                                            restaurantesTodosIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 0.0, 16.0, 8.0),
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                            'ProductosXRestaurante',
                                            queryParameters: {
                                              'rest': serializeParam(
                                                restaurantesTodosItem.nombre,
                                                ParamType.String,
                                              ),
                                            }.withoutNulls,
                                          );
