...
import 'productos_list_pollo_model.dart';
export 'productos_list_pollo_model.dart';

class ProductosListPolloWidget extends StatefulWidget {
  const ProductosListPolloWidget({Key? key}) : super(key: key);

  @override
  _ProductosListPolloWidgetState createState() =>
      _ProductosListPolloWidgetState();
}

class _ProductosListPolloWidgetState extends State<ProductosListPolloWidget> {
  late ProductosListPolloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosListPolloModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> productosListPolloCarritoRecordList =
            snapshot.data!;
        final productosListPolloCarritoRecord =
            productosListPolloCarritoRecordList.isNotEmpty
                ? productosListPolloCarritoRecordList.first
                : null;
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                if (productosListPolloCarritoRecord !=
                                                    null) {
                                                  ...
                                                  await productosListPolloCarritoRecord!
                                                      .reference
                                                      .update({
                                                    ...mapToFirestore(
                                                      {
