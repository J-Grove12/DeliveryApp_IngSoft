              ...
              children: [
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Builder(
                          builder: (context) {
                            final comidaSeleciionados = carritoCarritoRecord
                                    ?.comidasSeleccionada
                                    ?.toList() ??
                                [];
                            return ListView.builder(
                              ...
                              itemCount: comidaSeleciionados.length,
                              itemBuilder: (context, comidaSeleciionadosIndex) {
                                final comidaSeleciionadosItem =
                                    comidaSeleciionados[
                                        comidaSeleciionadosIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 8.0, 16.0, 0.0),
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: StreamBuilder<
                                        ...
                                        stream: ComidaSeleccionadaRecord
                                            .getDocument(
                                                comidaSeleciionadosItem),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                          ...
                                          final rowComidaSeleccionadaRecord =
                                              snapshot.data!;
                                          return Row(
                                            mainAxisSize: MainAxisSize.max,
                                            mainAxisAlignment:
                                            ...
                                            children: [
                                              Hero(
                                                tag: rowComidaSeleccionadaRecord
                                                    .imagen,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options: ['Tarjeta', 'efectivo'].toList(),
                ...
                StreamBuilder<List<OrdenRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<OrdenRecord> containerOrdenRecordList = snapshot.data!;
                    final containerOrdenRecord =
                        containerOrdenRecordList.isNotEmpty
                            ? containerOrdenRecordList.first
                            : null;
                    return InkWell(
                        ...
                        context.pushNamed(
                          ...
                          queryParameters: {
                            ...
                            'numeropedido': serializeParam(
                              carritoCarritoRecord?.reference.id,
                              ParamType.String,
                            ),
                          }.withoutNulls,
                        );

                        if (containerOrdenRecord != null) {
                          await containerOrdenRecord!.reference
                              .update(createOrdenRecordData(
                            entregada: false,
                            carrito: carritoCarritoRecord?.reference,
