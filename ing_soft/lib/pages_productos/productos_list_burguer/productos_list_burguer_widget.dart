...
import 'productos_list_burguer_model.dart';
export 'productos_list_burguer_model.dart';

class ProductosListBurguerWidget extends StatefulWidget {
  const ProductosListBurguerWidget({Key? key}) : super(key: key);

  @override
  _ProductosListBurguerWidgetState createState() =>
      _ProductosListBurguerWidgetState();
}

class _ProductosListBurguerWidgetState
    extends State<ProductosListBurguerWidget> {
  late ProductosListBurguerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosListBurguerModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> productosListBurguerCarritoRecordList =
            snapshot.data!;
        final productosListBurguerCarritoRecord =
            productosListBurguerCarritoRecordList.isNotEmpty
                ? productosListBurguerCarritoRecordList.first
                : null;
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              highlightColor:
                                                  Colors.transparent,
                                              onTap: () async {
                                                if (productosListBurguerCarritoRecord !=
                                                    null) {
                                                  ...
                                                  await productosListBurguerCarritoRecord!
                                                      .reference
                                                      .update({
                                                    ...mapToFirestore(
                                                      {
