...
class Log1Widget extends StatefulWidget {
  ...
  @override
  _Log1WidgetState createState() => _Log1WidgetState();
}

class _Log1WidgetState extends State<Log1Widget> with TickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/isometric-food-order-completed.png',
                  width: 219.0,
                  height: 221.0,
                  fit: BoxFit.cover,
                ),
